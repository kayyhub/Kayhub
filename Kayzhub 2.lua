local KAYZZHUB_DISCORD = "https://discord.gg/uq7Pd3HuP"
-- Compilacion de compatibilidad sin pragma
	...
	do
	local guiRootNames = {
	"KayzzHub_Panel", "KayzzHubHub", "CRYSTAL_Panel", "DashEffectGui", "CrystalAutoGrabBar",
	...
	_G.__KayzzHubAddOriginalGui3Title = function(parent, panel)
	if parent then parent.Text = string.upper(tostring(panel or "KAYZZHUB")) end
	end
	...
	local darkPalette = {
	["245,250,255"] = Color3.fromRGB(55, 145, 220),
	["235,245,255"] = Color3.fromRGB(55, 145, 220),
	["210,230,250"] = Color3.fromRGB(55, 145, 220),
	["190,220,250"] = Color3.fromRGB(75, 170, 240),
	["140,190,240"] = Color3.fromRGB(75, 170, 240),
	["80,160,255"] = Color3.fromRGB(75, 170, 240),
	["50,110,190"] = Color3.fromRGB(110, 190, 250),
	["80,130,200"] = Color3.fromRGB(110, 190, 250),
	["40,80,150"] = Color3.fromRGB(110, 190, 250),
	["30,90,200"] = Color3.fromRGB(110, 190, 250),
	["60,120,200"] = Color3.fromRGB(110, 190, 250),
	["100,140,200"] = Color3.fromRGB(110, 190, 250),
	}
	...
	local dark = theme == "GUI 2" and Color3.fromRGB(55, 145, 220) or Color3.fromRGB(55, 145, 220)
	local bright = theme == "GUI 2" and Color3.fromRGB(110, 190, 250) or Color3.fromRGB(75, 170, 240)
	...
	local key = string.format("%d,%d,%d", math.floor(color.R * 255 + 0.5), math.floor(color.G * 255 + 0.5), math.floor(color.B * 255 + 0.5))
	if color.B > color.R + 12 and color.B >= color.G then instance.Color = Color3.fromRGB(8, 30, 55)
...
_G.__CrystalAddUnifiedPanelShade = function(parent, cornerRadius, zIndex)
	...
	shade.BackgroundColor3 = Color3.fromRGB(8, 30, 55)
	...
	outline.Color = Color3.fromRGB(215, 242, 255)
	...
	ColorSequenceKeypoint.new(0, Color3.fromRGB(215, 242, 255)),
	ColorSequenceKeypoint.new(1, Color3.fromRGB(142, 167, 184)),
	})
	local softGlow = Instance.new("UIStroke")
	softGlow.Name = "UnifiedPanelWhiteGlow"
	softGlow.Color = Color3.fromRGB(215, 242, 255)
...
toggleDefaults["Optimizer"] = true
	...
	table.insert(lines, "M:themePrimary=" .. (_G.__CrystalThemePrimary or "BLUE"))
	...
	if v == "BLUE" then _G.__CrystalThemePrimary = v end
	...
	-- ==================== CREAR SCREEN GUI ====================
	-- Bootstrap mínimo: KayzzHub Modern reemplaza por completo la carcasa Uranium.
	local ScreenGui = Instance.new("ScreenGui")
	ScreenGui.Name = "KayzzHubHub"
...
if fpsBoostCharConn then fpsBoostCharConn:Disconnect() end
	...
	if name:match("^Crystal") or name:match("^__Crystal") or name:match("^KayzzHub")
	...
	-- Igual que KayzzHub Prime: protege solo las animaciones del jugador local.
	local char = Player.Character
	...
	enemyWidget.BackgroundColor3 = Color3.fromRGB(8, 30, 55)
	...
	stroke.Color = Color3.fromRGB(8, 30, 55)
	stroke.Thickness = 1
	...
	titleLbl.TextColor3 = Color3.fromRGB(154, 180, 196)
	...
	avatarImg.BackgroundColor3 = Color3.fromRGB(28, 51, 75)
	...
	avatarStroke.Color = Color3.fromRGB(154, 180, 196)
	...
	nameLbl.TextSize = 13
	nameLbl.TextColor3 = Color3.fromRGB(154, 180, 196)
	...
	timerLbl.TextColor3 = Color3.fromRGB(170, 220, 255)
	...
	nameLbl.TextColor3 = Color3.fromRGB(75, 170, 240)
	else
	nameLbl.TextColor3 = Color3.fromRGB(154, 180, 196)
	end
	end
...
if toggleStates["Anti Ragdoll"] then startAntiRagdoll() end
	...
	ColorSequenceKeypoint.new(0.5, Color3.fromRGB(215, 242, 255)),
	ColorSequenceKeypoint.new(1, Color3.fromRGB(170, 220, 255)),
	})
	local LOCAL_SPEED_GRADIENT_GUI2 = ColorSequence.new({
	ColorSequenceKeypoint.new(0, Color3.fromRGB(75, 170, 240)),
	ColorSequenceKeypoint.new(0.5, Color3.fromRGB(110, 190, 250)),
	ColorSequenceKeypoint.new(1, Color3.fromRGB(75, 170, 240)),
	})

	local function getSpeedThemeGradient(isLocal)
	if _G.__CrystalGuiTheme == "GUI 3" then
	return ColorSequence.new(Color3.fromRGB(75, 170, 240), Color3.fromRGB(75, 170, 240))
	end
	if isLocal then
	return _G.__CrystalGuiTheme == "GUI 2" and LOCAL_SPEED_GRADIENT_GUI2 or LOCAL_SPEED_GRADIENT_GUI1
	end
	return ColorSequence.new({
	ColorSequenceKeypoint.new(0, Color3.fromRGB(195, 221, 235)),
	ColorSequenceKeypoint.new(0.5, Color3.fromRGB(215, 242, 255)),
	ColorSequenceKeypoint.new(1, Color3.fromRGB(170, 196, 212)),
	})
	end
	...
	if localOnly then
	lbl.TextColor3 = Color3.fromRGB(215, 242, 255)
	...
	discordLbl.Size = UDim2.new(1, 0, 0, isLocal and 24 or 20)
	discordLbl.Position = UDim2.new(0, 0, 0, 0)
	discordLbl.BackgroundTransparency = 1
	discordLbl.Text = "discord.gg/uq7Pd3HuP"
	discordLbl.Visible = true
	discordLbl.TextScaled = false
	discordLbl.TextSize = isLocal and 17 or 13
	...
	speedLbl.Position = UDim2.new(0, 0, 0, isLocal and 24 or 20)
...
_G.__CrystalTrackConn(RunService.PostSimulation:Connect(alwaysOnAntiFling))
	...
	* CFrame.Angles(0, yaw, 0)
	...
	label.TextColor3 = Color3.fromRGB(154, 179, 196)
	label.TextStrokeColor3 = Color3.fromRGB(8, 30, 55)
	...
	if not animateText("STEAL!", Color3.fromRGB(154, 179, 196)) then return end
	end)
...
if toggleStates["Medusa Counter"] then
	...
	-- La marca persistente de TP Bat de KayzzHub sustituye completamente a la
...
-- Motor delegado anterior eliminado: TP Bat usa ahora un unico motor V1.
	...
	local Camera = workspace.CurrentCamera
	local GUI2_ESP_COLOR = Color3.fromRGB(75, 170, 240)
	local GUI2_ESP_TEXT_STROKE = Color3.fromRGB(55, 145, 220)
	local function getESPThemeColors(accent)
	if _G.__CrystalGuiTheme == "GUI 3" then
	return Color3.fromRGB(75, 170, 240), Color3.fromRGB(75, 170, 240)
	end
	if _G.__CrystalGuiTheme == "GUI 2" then
	return GUI2_ESP_COLOR, GUI2_ESP_COLOR
	end
	return accent or _G.__CrystalThemeAccent or Color3.fromRGB(207, 234, 247), Color3.fromRGB(8, 30, 55)
	end
	...
	esp.Highlight.OutlineColor = Color3.fromRGB(8, 30, 55)
	...
	nameLabel.TextColor3 = _G.__CrystalGuiTheme == "GUI 3" and Color3.fromRGB(75, 170, 240) or (_G.__CrystalGuiTheme == "GUI 2" and GUI2_ESP_COLOR or Color3.fromRGB(207, 234, 248))
	nameLabel.TextSize = 15
	nameLabel.Font = Enum.Font.GothamBold
	nameLabel.TextStrokeColor3 = _G.__CrystalGuiTheme == "GUI 2" and GUI2_ESP_TEXT_STROKE or Color3.fromRGB(8, 30, 55)
	...
	nameOutline.Color = _G.__CrystalGuiTheme == "GUI 2" and GUI2_ESP_TEXT_STROKE or Color3.fromRGB(8, 30, 55)
	...
	esp.NameLabel.TextColor3 = _G.__CrystalGuiTheme == "GUI 3" and Color3.fromRGB(75, 170, 240) or (_G.__CrystalGuiTheme == "GUI 2" and GUI2_ESP_COLOR or Color3.fromRGB(207, 234, 248))
	esp.NameLabel.TextStrokeColor3 = _G.__CrystalGuiTheme == "GUI 2" and GUI2_ESP_TEXT_STROKE or Color3.fromRGB(8, 30, 55)
	end
	if esp.NameOutline then
	esp.NameOutline.Color = _G.__CrystalGuiTheme == "GUI 2" and GUI2_ESP_TEXT_STROKE or Color3.fromRGB(8, 30, 55)
	end
	...
	esp.NameLabel.TextColor3 = _G.__CrystalGuiTheme == "GUI 3" and Color3.fromRGB(75, 170, 240) or (gui2Active and GUI2_ESP_COLOR or Color3.fromRGB(207, 234, 248))
	esp.NameLabel.TextStrokeColor3 = gui2Active and GUI2_ESP_TEXT_STROKE or Color3.fromRGB(8, 30, 55)
	if esp.NameOutline then
	esp.NameOutline.Color = gui2Active and GUI2_ESP_TEXT_STROKE or Color3.fromRGB(8, 30, 55)
	end
	end)
	end
	else
...
if toggleStates["ESP Players"] then enableESP() end
	...
	tracerOutline.Color = Color3.fromRGB(215, 242, 255)
	...
	delBtn.ZIndex = 30
	delBtn.BackgroundColor3 = Color3.fromRGB(170, 220, 255)
	delBtn.BorderSizePixel = 0
	delBtn.Text = "x"
	delBtn.TextColor3 = Color3.fromRGB(75, 170, 240)
	delBtn.TextSize = 11
	...
	addBtn.BackgroundColor3 = Color3.fromRGB(202, 229, 243)
	addBtn.BackgroundTransparency = 0.55
	addBtn.BorderSizePixel = 0
	addBtn.Text = "+ Add Custom Speed"
	addBtn.TextColor3 = Color3.fromRGB(75, 170, 240)
	addBtn.TextSize = 11
	addBtn.Font = Enum.Font.GothamBold
	addBtn.AutoButtonColor = false
	Instance.new("UICorner", addBtn).CornerRadius = UDim.new(0, 6)
	local addStroke = Instance.new("UIStroke", addBtn)
	addStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	formCard.BackgroundColor3 = Color3.fromRGB(170, 220, 255)
	...
	formStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	boostLbl.Text = "Boost"
	boostLbl.TextColor3 = Color3.fromRGB(75, 170, 240)
	boostLbl.TextSize = 9
	...
	boostBox.BackgroundColor3 = Color3.fromRGB(170, 220, 255)
	boostBox.BorderSizePixel = 0
	boostBox.Text = "59"
	boostBox.Font = Enum.Font.GothamBold
	boostBox.TextSize = 12
	boostBox.TextColor3 = Color3.fromRGB(75, 170, 240)
	...
	boostStroke2.Color = Color3.fromRGB(8, 30, 55)
	...
	stealLbl.Text = "Steal"
	stealLbl.TextColor3 = Color3.fromRGB(75, 170, 240)
	stealLbl.TextSize = 9
	...
	stealBox.BackgroundColor3 = Color3.fromRGB(170, 220, 255)
	stealBox.BorderSizePixel = 0
	stealBox.Text = "29"
	stealBox.Font = Enum.Font.GothamBold
	stealBox.TextSize = 12
	stealBox.TextColor3 = Color3.fromRGB(75, 170, 240)
	...
	stealStroke2.Color = Color3.fromRGB(8, 30, 55)
	...
	confirmBtn.BackgroundColor3 = Color3.fromRGB(75, 170, 240)
	confirmBtn.BorderSizePixel = 0
	confirmBtn.Text = "Add Speed"
	confirmBtn.TextColor3 = Color3.fromRGB(215, 242, 255)
	...
	errLbl.Text = ""
	errLbl.TextColor3 = Color3.fromRGB(75, 170, 240)
	errLbl.TextSize = 9
	...
	autoplayModeButton.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
	autoplayModeButton.BorderSizePixel = 0
	autoplayModeButton.Text = string.upper(_G.__autoplayMode or "Full")
	autoplayModeButton.TextColor3 = Color3.fromRGB(170, 220, 255)
	...
	autoplayModeStroke.Color = Color3.fromRGB(215, 242, 255)
	...
	vBtn.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
	vBtn.BorderSizePixel = 0
	vBtn.Text = "V1"
	vBtn.TextColor3 = Color3.fromRGB(170, 220, 255)
	vBtn.TextSize = 10
	...
	vStroke.Color = Color3.fromRGB(215, 242, 255)
	vStroke.Thickness = 1
	...
	c.BackgroundColor3 = Color3.fromRGB(55, 145, 220)
	...
	if stroke then stroke.Color = Color3.fromRGB(8, 30, 55); stroke.Thickness = 1; stroke.Transparency = 0 end
	break
	end
	end
	end)
	...
	infJumpModeBtn.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
	infJumpModeBtn.BorderSizePixel = 0
	infJumpModeBtn.Text = (_G.__CrystalInfJumpMode == "hold") and "HOLD" or "MANUAL"
	infJumpModeBtn.TextColor3 = Color3.fromRGB(170, 220, 255)
	...
	infJumpModeStroke.Color = Color3.fromRGB(215, 242, 255)
...
batVersionPill.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
batVersionPill.BorderSizePixel = 0
batVersionPill.Text = "V" .. tostring(_G.__batVersion or 1)
batVersionPill.TextColor3 = Color3.fromRGB(170, 220, 255)
...
bvStroke.Color = Color3.fromRGB(215, 242, 255)
...
distanceConfigPill.BackgroundColor3 = Color3.fromRGB(55, 145, 220)
...
distanceToggleStroke.Color = Color3.fromRGB(110, 190, 250)
...
configToggleLabel.TextColor3 = Color3.fromRGB(170, 220, 255)
...
configSwitchTrack.BackgroundColor3 = Color3.fromRGB(30, 52, 76)
...
configSwitchKnob.BackgroundColor3 = Color3.fromRGB(110, 190, 250)
...
distancePanel.BackgroundColor3 = Color3.fromRGB(55, 145, 220)
...
distancePanelStroke.Color = Color3.fromRGB(75, 170, 240)
...
distanceInput.BackgroundColor3 = Color3.fromRGB(55, 145, 220)
...
distanceInput.TextColor3 = Color3.fromRGB(209, 236, 249)
...
distanceInputStroke.Color = Color3.fromRGB(110, 190, 250)
...
versionInsideLabel.TextColor3 = Color3.fromRGB(170, 220, 255)
...
versionInsidePill.BackgroundColor3 = Color3.fromRGB(75, 170, 240)
versionInsidePill.BorderSizePixel = 0
versionInsidePill.Text = "V" .. tostring(_G.__batVersion or 1)
versionInsidePill.TextColor3 = Color3.fromRGB(209, 236, 249)
...
versionInsideStroke.Color = Color3.fromRGB(110, 190, 250)
...
distanceConfigPill.BackgroundColor3 = visible and Color3.fromRGB(75, 170, 240) or Color3.fromRGB(55, 145, 220)
distanceToggleStroke.Color = visible and Color3.fromRGB(110, 190, 250) or Color3.fromRGB(110, 190, 250)
configSwitchTrack.BackgroundColor3 = visible and Color3.fromRGB(75, 170, 240) or Color3.fromRGB(30, 52, 76)
configSwitchKnob.BackgroundColor3 = visible and Color3.fromRGB(209, 236, 249) or Color3.fromRGB(110, 190, 250)
...
_G.__batVersion = tonumber(_G.__batVersion) == 2 and 2 or 1
batVersionPill.Text = "V" .. tostring(_G.__batVersion or 1)
batVersionPill.BackgroundColor3 = Color3.fromRGB(55, 145, 220)
batVersionPill.TextColor3 = Color3.fromRGB(209, 236, 249)
bvStroke.Color = Color3.fromRGB(170, 220, 255)
versionInsidePill.Text = "V" .. tostring(_G.__batVersion or 1)
versionInsidePill.BackgroundColor3 = Color3.fromRGB(55, 145, 220)
versionInsideStroke.Color = Color3.fromRGB(170, 220, 255)
...
marker.Color = Color3.fromRGB(75, 170, 240)
...
overlaySphere.Color3 = Color3.fromRGB(75, 170, 240)
...
highlight.FillColor = Color3.fromRGB(75, 170, 240)
highlight.FillTransparency = 0.15
highlight.OutlineColor = Color3.fromRGB(110, 190, 250)
...
label.TextStrokeColor3 = Color3.fromRGB(55, 145, 220)
...
-- Motores TP Bat: V1 original + V2 directo de Zurich, con estado compartido.
	...
	grabBarGui.BackgroundColor3 = Color3.fromRGB(174, 200, 216)
	...
	barStrokeInst.Color = Color3.fromRGB(126, 151, 169)
	...
	ColorSequenceKeypoint.new(0, Color3.fromRGB(187, 213, 228)),
	ColorSequenceKeypoint.new(1, Color3.fromRGB(162, 188, 204)),
	})
	...
	statsDivider.BackgroundColor3 = Color3.fromRGB(134, 159, 177)
	...
	StatsRightFps.TextColor3 = Color3.fromRGB(8, 30, 55)
	...
	StatsRightPing.TextColor3 = Color3.fromRGB(8, 30, 55)
	...
	percentLabel.TextColor3 = Color3.fromRGB(8, 30, 55)
	...
	resizeBtn.BackgroundColor3 = Color3.fromRGB(97, 121, 141)
	resizeBtn.TextColor3 = Color3.fromRGB(202, 229, 243)
	...
	barBg.BackgroundColor3 = Color3.fromRGB(146, 171, 188)
	...
	barFill.BackgroundColor3 = Color3.fromRGB(109, 134, 153)
	barFill.ClipsDescendants = true
	barFill.ZIndex = 502
	Instance.new("UICorner", barFill).CornerRadius = UDim.new(1, 0)
	local fillGradient = Instance.new("UIGradient", barFill)
	local barThemeColor = Color3.fromRGB(109, 134, 153)
	local function applyAutoStealBarTheme(themeName)
	barThemeColor = Color3.fromRGB(109, 134, 153)
	fillGradient.Color = ColorSequence.new({
	ColorSequenceKeypoint.new(0, Color3.fromRGB(126, 151, 169)),
	ColorSequenceKeypoint.new(1, Color3.fromRGB(93, 117, 137)),
	})
	...
	barLabel.TextColor3 = Color3.fromRGB(8, 30, 55)
	...
	statusLabel.Text = ""
	statusLabel.TextColor3 = Color3.fromRGB(8, 30, 55)
	...
	barPercentLabel.TextColor3 = Color3.fromRGB(8, 30, 55)
	...
	titleLabel.Text = "Kayzz Auto Grab " .. autoGrabModeName(autoStealMode)
	titleLabel.TextColor3 = Color3.fromRGB(8, 30, 55)
	...
	barFill.BackgroundColor3 = barThemeColor
	barStrokeInst.Color = Color3.fromRGB(84, 108, 129)
	barStrokeInst.Transparency = 0.08
	titleLabel.TextColor3 = Color3.fromRGB(215, 242, 255)
	end
	...
	modeBtn.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
	modeBtn.BorderSizePixel = 0
	modeBtn.TextColor3 = Color3.fromRGB(170, 220, 255)
	modeBtn.TextSize = 10
	...
	modeStroke.Color = Color3.fromRGB(215, 242, 255)
	...
	-- Motor DawgOpt de KayzzHub Prime para Normal y derender agresivo para Ultra.
	local lowFlags = {
...
if optimizerActive and FeaturePostToggle["Optimizer"] then FeaturePostToggle["Optimizer"](false) end
	...
	if kind == "blue" then
	Lighting.Ambient = Color3.fromRGB(55, 145, 220)
	Lighting.FogColor = Color3.fromRGB(75, 170, 240)
	cc.TintColor = Color3.fromRGB(110, 190, 250)
	cc.Saturation = 0.4
	cc.Contrast = 0.1
	...
	Lighting.Ambient = Color3.fromRGB(122, 146, 165)
	cc.TintColor = Color3.fromRGB(215, 242, 255)
	cc.Saturation = 0.1
	cc.Contrast = 0
	end
	end
	...
	skyModeBtn.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
	skyModeBtn.BorderSizePixel = 0
	skyModeBtn.Text = "BLUE"
	skyModeBtn.TextColor3 = Color3.fromRGB(170, 220, 255)
	...
	skyModeStroke.Color = Color3.fromRGB(215, 242, 255)
	...
	mainThemesBtn.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
	...
	mainThemesBtn.TextColor3 = Color3.fromRGB(202, 229, 243)
	...
	mainThemesBtnStroke.Color = Color3.fromRGB(215, 242, 255)
	...
	mainThemesFrame.BackgroundColor3 = Color3.fromRGB(75, 170, 240)
	...
	ColorSequenceKeypoint.new(0, Color3.fromRGB(75, 170, 240)),
	ColorSequenceKeypoint.new(0.48, Color3.fromRGB(75, 170, 240)),
	ColorSequenceKeypoint.new(1, Color3.fromRGB(55, 145, 220)),
	})
	...
	themesStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	stroke.Color = Color3.fromRGB(215, 242, 255)
	...
	card.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
	card.BackgroundTransparency = 1
	...
	cardLabel.TextColor3 = Color3.fromRGB(202, 229, 243)
	cardLabel.TextSize = 8
	cardLabel.Font = Enum.Font.GothamBold
	cardLabel.ZIndex = 23
	cardLabel.TextStrokeColor3 = Color3.fromRGB(55, 145, 220)
	cardLabel.TextStrokeTransparency = 0.25
	local cardStroke = Instance.new("UIStroke", card)
	cardStroke.Color = Color3.fromRGB(215, 242, 255)
	...
	saveThemeButton.BackgroundColor3 = Color3.fromRGB(110, 190, 250)
	saveThemeButton.BorderSizePixel = 0
	saveThemeButton.Text = "Save Theme"
	saveThemeButton.TextColor3 = Color3.fromRGB(202, 229, 243)
	...
	button.BackgroundColor3 = Color3.fromRGB(18, 52, 88)
	...
	button.TextColor3 = Color3.fromRGB(220, 245, 255)
	button.TextStrokeColor3 = Color3.fromRGB(8, 30, 55)
	...
	if active then
	button.BackgroundColor3 = Color3.fromRGB(65, 160, 235)
	button.BackgroundTransparency = 0
	button.TextColor3 = Color3.fromRGB(225, 248, 255)
	button.TextStrokeTransparency = 0.5
	stroke.Color = Color3.fromRGB(110, 190, 250)
	...
	panelsPanel.BackgroundColor3 = Color3.fromRGB(55, 145, 220)
	...
	panelsPanelStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	bypassBtn.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
	bypassBtn.BackgroundTransparency = 0.15
	bypassBtn.BorderSizePixel = 0
	bypassBtn.Text = "BYPASS"
	bypassBtn.TextColor3 = Color3.fromRGB(75, 170, 240)
	...
	bypassStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	laggerBtn.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
	laggerBtn.BackgroundTransparency = 0.15
	laggerBtn.BorderSizePixel = 0
	laggerBtn.Text = "LAGGER"
	laggerBtn.TextColor3 = Color3.fromRGB(75, 170, 240)
	...
	laggerStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	laggerBtn.BackgroundColor3 = laggerToggled and Color3.fromRGB(110, 190, 250) or Color3.fromRGB(33, 55, 79)
	laggerBtn.TextColor3 = laggerToggled and Color3.fromRGB(215, 242, 255) or Color3.fromRGB(75, 170, 240)
		laggerStroke.Color = laggerToggled and Color3.fromRGB(215, 242, 255) or Color3.fromRGB(8, 30, 55)
	...
	container.BackgroundColor3 = Color3.fromRGB(55, 145, 220)
	container.BackgroundTransparency = 0.12
	container.BorderSizePixel = 0
	container.Parent = animSection
	Instance.new("UICorner", container).CornerRadius = UDim.new(0,8)
	local containerStroke = Instance.new("UIStroke", container)
	containerStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	animTogglePanel.BackgroundColor3 = Color3.fromRGB(36, 59, 82)
	...
	animToggleBtn.BackgroundColor3 = Color3.fromRGB(55, 145, 220)
	animToggleBtn.BorderSizePixel = 0
	animToggleBtn.Text = "OFF"
	animToggleBtn.TextColor3 = Color3.fromRGB(208, 235, 249)
	...
	animToggleBtn.BackgroundColor3 = animsEnabled and Color3.fromRGB(75, 170, 240) or Color3.fromRGB(55, 145, 220)
	animToggleBtn.TextColor3 = Color3.fromRGB(215, 242, 255)
	animToggleBtn.Font = Enum.Font.GothamBold
	end
	...
	leftBtn.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
	leftBtn.BackgroundTransparency = 0.15
	leftBtn.BorderSizePixel = 0
	leftBtn.Text = "◄"
	leftBtn.TextColor3 = Color3.fromRGB(170, 220, 255)
	leftBtn.TextSize = 20
	...
	titleLabel.TextColor3 = Color3.fromRGB(170, 220, 255)
	...
	rightBtn.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
	rightBtn.BackgroundTransparency = 0.15
	rightBtn.BorderSizePixel = 0
	rightBtn.Text = "►"
	rightBtn.TextColor3 = Color3.fromRGB(170, 220, 255)
	...
	TweenService:Create(btn, TweenInfo.new(0.08), {BackgroundColor3 = Color3.fromRGB(75, 170, 240)}):Play()
	task.delay(0.08, function() TweenService:Create(btn, TweenInfo.new(0.08), {BackgroundColor3 = Color3.fromRGB(33, 55, 79)}):Play() end)
	end
	...
	TweenService:Create(leftBtn, TweenInfo.new(0.15), {BackgroundTransparency = 0, TextColor3 = Color3.fromRGB(215, 242, 255)}):Play()
	end)
	leftBtn.MouseLeave:Connect(function()
	TweenService:Create(leftBtn, TweenInfo.new(0.15), {BackgroundTransparency = 0.15, TextColor3 = Color3.fromRGB(170, 220, 255)}):Play()
	end)
	rightBtn.MouseEnter:Connect(function()
	TweenService:Create(rightBtn, TweenInfo.new(0.15), {BackgroundTransparency = 0, TextColor3 = Color3.fromRGB(215, 242, 255)}):Play()
	end)
	rightBtn.MouseLeave:Connect(function()
	TweenService:Create(rightBtn, TweenInfo.new(0.15), {BackgroundTransparency = 0.15, TextColor3 = Color3.fromRGB(170, 220, 255)}):Play()
	end)
	...
	if not isPng then
	warn("Kazy Lagger: no se pudo descargar el fondo ug6eug")
	return LAGGER_BACKGROUND_FALLBACK
	end
	...
	local WHITE = Color3.fromRGB(202, 229, 243)
	...
	keybindStroke.Color = Color3.fromRGB(8, 30, 55)
	end
	end
	...
	mainFrame.BackgroundColor3 = Color3.fromRGB(14, 37, 61)
	...
	mainStroke.Color = Color3.fromRGB(32, 55, 79)
	...
	title.TextColor3 = Color3.fromRGB(215, 242, 255)
	title.TextSize = 16
	...
	laggerTitle.TextColor3 = Color3.fromRGB(215, 242, 255)
	...
	_G.__KayzzHubAddOriginalGui3Title(title, "Lagger")
	refreshLaggerThemeText = function()
	-- El PNG ya incluye "KAZY LAGGER"; evita duplicar el rotulo encima.
	title.Visible = false
	end
	...
	closeButton.TextColor3 = Color3.fromRGB(215, 242, 255)
	...
	minimizeButton.TextColor3 = Color3.fromRGB(215, 242, 255)
	...
	minimizedToggleButton.TextColor3 = Color3.fromRGB(202, 229, 243)
	minimizedToggleButton.TextStrokeColor3 = Color3.fromRGB(8, 30, 55)
	minimizedToggleButton.TextStrokeTransparency = 1
	minimizedToggleButton.TextSize = 11
	minimizedToggleButton.BackgroundColor3 = Color3.fromRGB(36, 59, 82)
	...
	minimizedToggleStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	controlFrame.BackgroundColor3 = Color3.fromRGB(24, 47, 71)
	...
	keybindButton.BackgroundColor3 = Color3.fromRGB(32, 55, 79)
	...
	keybindStroke.Color = Color3.fromRGB(49, 72, 94)
	...
	switchBackground.BackgroundColor3 = Color3.fromRGB(215, 242, 255)
	...
	toggleKnob.BackgroundColor3 = Color3.fromRGB(36, 59, 82)
	...
	powerFrame.BackgroundColor3 = Color3.fromRGB(24, 47, 71)
	...
	powerBar.BackgroundColor3 = Color3.fromRGB(42, 65, 88)
	...
	powerFill.BackgroundColor3 = Color3.fromRGB(202, 229, 243)
	...
	powerKnob.BackgroundColor3 = Color3.fromRGB(215, 242, 255)
	...
	keybindButton.BackgroundTransparency = 0.6
		if keybindStroke then keybindStroke.Color = Color3.fromRGB(8, 30, 55) end
	...
	minimizedToggleButton.BackgroundColor3 = active and Color3.fromRGB(178, 204, 219) or Color3.fromRGB(36, 59, 82)
	minimizedToggleButton.TextColor3 = Color3.fromRGB(215, 242, 255)
	end
	...
	descendant:SetAttribute("KayzzHubKeepBlackText", true)
	descendant.TextStrokeColor3 = Color3.fromRGB(8, 30, 55)
	...
	bypassBtn.BackgroundColor3 = bypassToggled and Color3.fromRGB(110, 190, 250) or Color3.fromRGB(33, 55, 79)
	bypassBtn.TextColor3 = bypassToggled and Color3.fromRGB(215, 242, 255) or Color3.fromRGB(75, 170, 240)
		bypassStroke.Color = bypassToggled and Color3.fromRGB(215, 242, 255) or Color3.fromRGB(8, 30, 55)
	...
	and imageData:sub(1, 8) == "\137PNG\r\n\26\n"
	if not isPng then
	warn("Kayz Bypass: no se pudo descargar el fondo 5slzyj")
	return BYPASS_BACKGROUND_FALLBACK
	end
	...
	local WHITE, NAVY_TEXT = Color3.fromRGB(202, 229, 243), Color3.fromRGB(55, 145, 220)
	...
	Instance.new("UICorner", mainFrame).CornerRadius = UDim.new(0,16)
	local mainStroke = Instance.new("UIStroke", mainFrame)
	mainStroke.Color = Color3.fromRGB(155, 180, 197)
	...
	glow.Name = "Glow"
	glow.Color = Color3.fromRGB(163, 189, 205)
	glow.Thickness = 4
	glow.Transparency = 1
	glow.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
	local glow2 = Instance.new("UIStroke", mainFrame)
	glow2.Name = "Glow2"
	glow2.Color = Color3.fromRGB(215, 242, 255)
	glow2.Thickness = 6
	...
	bypassMinimizeButton.BackgroundColor3 = Color3.fromRGB(31, 53, 77)
	...
	bypassMinimizeButton.TextStrokeColor3 = Color3.fromRGB(8, 30, 55)
	...
	bypassMinimizeStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	bypassMinimizedToggle.BackgroundColor3 = Color3.fromRGB(36, 59, 82)
	...
	bypassMinimizedToggle.TextStrokeColor3 = Color3.fromRGB(8, 30, 55)
	...
	bypassMinimizedStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	bypassMinimizedToggle.BackgroundColor3 = bypassRunning and Color3.fromRGB(178, 204, 219) or Color3.fromRGB(36, 59, 82)
	bypassMinimizedToggle.TextColor3 = WHITE
	end
	...
	titleStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	_G.__KayzzHubAddOriginalGui3Title(title, "Bypass")
	-- El PNG ya incluye "KAYZ BYPASS"; evita duplicar el rotulo encima.
	title.Visible = false
	...
	titleShadow.Text = ""
	titleShadow.TextColor3 = Color3.fromRGB(55, 145, 220)
	...
	pageStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	themesFrame.BackgroundColor3 = Color3.fromRGB(66, 90, 111)
	...
	themesGradient.Color = ColorSequence.new({
	ColorSequenceKeypoint.new(0, Color3.fromRGB(55, 78, 100)),
	ColorSequenceKeypoint.new(0.48, Color3.fromRGB(83, 106, 127)),
	ColorSequenceKeypoint.new(1, Color3.fromRGB(50, 73, 96)),
	})
	themesGradient.Rotation = 35
	...
	cardLabel.TextStrokeTransparency = 0.25
	local cardStroke = Instance.new("UIStroke", card)
	cardStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	saveThemeButton.Size = UDim2.new(1, -24, 0, 28)
	saveThemeButton.Position = UDim2.new(0, 12, 1, -44)
	saveThemeButton.BackgroundColor3 = Color3.fromRGB(93, 117, 137)
	saveThemeButton.BorderSizePixel = 0
	saveThemeButton.Text = "Save Theme"
	...
	versionButton.BackgroundColor3 = Color3.fromRGB(31, 53, 77)
	...
	versionStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	modeFrame.BackgroundColor3 = Color3.fromRGB(24, 47, 71)
	...
	modeStroke.Color = Color3.fromRGB(40, 63, 86)
	...
	powerRow.BackgroundColor3 = Color3.fromRGB(26, 48, 72)
	...
	powerRowStroke.Color = Color3.fromRGB(40, 63, 86)
	...
	powerBox.BackgroundColor3 = Color3.fromRGB(32, 55, 79)
	...
	powerStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	toggleButton.BackgroundColor3 = Color3.fromRGB(36, 59, 82)
	...
	toggleStroke.Color = Color3.fromRGB(8, 30, 55)
	toggleStroke.Thickness = 1.2
	toggleStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
	local toggleGradient = Instance.new("UIGradient")
	toggleGradient.Color = ColorSequence.new(Color3.fromRGB(86, 110, 130), Color3.fromRGB(63, 87, 108))
	...
	autoRow.BackgroundColor3 = Color3.fromRGB(26, 48, 72)
	...
	autoRowStroke.Color = Color3.fromRGB(40, 63, 86)
	...
	autoPill.BackgroundColor3 = Color3.fromRGB(24, 47, 71)
	...
	autoPillStroke.Color = Color3.fromRGB(8, 30, 55)
	...
	autoKnob.BackgroundColor3 = Color3.fromRGB(57, 80, 102)
	...
	pcModeButton.BackgroundColor3 = pcSelected and Color3.fromRGB(53, 76, 98) or Color3.fromRGB(23, 45, 69)
	pcModeButton.TextColor3 = pcSelected and WHITE or Color3.fromRGB(73, 97, 118)
	mobileModeButton.BackgroundColor3 = pcSelected and Color3.fromRGB(23, 45, 69) or Color3.fromRGB(53, 76, 98)
	mobileModeButton.TextColor3 = pcSelected and Color3.fromRGB(73, 97, 118) or WHITE
	...
	title.TextColor3 = WHITE
	titleShadow.TextColor3 = useWhiteText and WHITE or Color3.fromRGB(55, 145, 220)
	...
	ColorSequenceKeypoint.new(0, Color3.fromRGB(191, 217, 231)),
	ColorSequenceKeypoint.new(1, Color3.fromRGB(166, 192, 208)),
	})
	if animated then
	TweenService:Create(toggleButton, TweenInfo.new(0.2), {
	BackgroundColor3 = Color3.fromRGB(61, 84, 106)
	}):Play()
	TweenService:Create(toggleStroke, TweenInfo.new(0.2), {
	Color = Color3.fromRGB(199, 225, 239),
	Thickness = 1.8,
	Transparency = 0
	}):Play()
	else
	toggleButton.BackgroundColor3 = Color3.fromRGB(61, 84, 106)
	toggleStroke.Color = Color3.fromRGB(199, 225, 239)
	...
	if animated then
	TweenService:Create(toggleButton, TweenInfo.new(0.2), {
	BackgroundColor3 = Color3.fromRGB(26, 48, 72)
	}):Play()
	TweenService:Create(toggleStroke, TweenInfo.new(0.2), {
			Color = Color3.fromRGB(8, 30, 55),
	Thickness = 1.2,
	Transparency = 0
	}):Play()
	else
	toggleButton.BackgroundColor3 = Color3.fromRGB(26, 48, 72)
			toggleStroke.Color = Color3.fromRGB(8, 30, 55)
	toggleStroke.Thickness = 1.2
	end
	end
	...
	local pillColor = autoState and Color3.fromRGB(174, 200, 216) or Color3.fromRGB(24, 47, 71)
	local knobPos = autoState and UDim2.new(0,16,0.5,-5) or UDim2.new(0,2,0.5,-5)
	local strokeColor = autoState and Color3.fromRGB(199, 225, 239) or Color3.fromRGB(53, 76, 98)
	...
	TweenService:Create(autoKnob, TweenInfo.new(0.2), {Position = knobPos, BackgroundColor3 = autoState and Color3.fromRGB(45, 67, 90) or Color3.fromRGB(57, 80, 102)}):Play()
	...
	autoKnob.BackgroundColor3 = autoState and Color3.fromRGB(45, 67, 90) or Color3.fromRGB(57, 80, 102)
	...
	BackgroundColor3 = Color3.fromRGB(36, 59, 82)
	}):Play()
	end
	end)
	...
	toggleUiLabel.TextColor3 = Color3.fromRGB(75, 170, 240)
	...
	toggleUiBindBtn.BackgroundColor3 = Color3.fromRGB(33, 55, 79)
	...
	toggleUiBindBtn.TextColor3 = Color3.fromRGB(170, 220, 255)
	...
	toggleUiStroke.Color = Color3.fromRGB(215, 242, 255)
	...
	listeningBindBtn.BackgroundColor3 = Color3.fromRGB(29, 51, 75)
	...
	toggleUiBindBtn.BackgroundColor3 = Color3.fromRGB(55, 145, 220)
	...
	presetButton.BackgroundColor3 = Color3.fromRGB(26, 49, 73)
	presetButton.BorderSizePixel = 0
	presetButton.Text = "Preset: " .. selectedAnimationPresetName
	presetButton.TextColor3 = Color3.fromRGB(215, 242, 255)
	...
	row.BackgroundColor3 = Color3.fromRGB(21, 44, 68)
	...
	label.TextColor3 = Color3.fromRGB(187, 214, 228)
	label.TextSize = 11
	...
	input.BackgroundColor3 = Color3.fromRGB(24, 47, 71)
	input.BorderSizePixel = 0
	input.Text = ""
	input.TextColor3 = Color3.fromRGB(215, 242, 255)
	input.TextSize = 10
	...
	infoLabel.TextColor3 = Color3.fromRGB(110, 190, 250)
    ...
    -- Botón flotante Uranium eliminado; KayzzHubRestoreButton es el único restaurador.
    local toggleBtn = nil
    _G.__toggleBtn = nil
    ...
    -- Mini panel Uranium temporal eliminado; KayzzHubRestoreButton es el único restaurador activo.
	...
	-- ==================== KAYZZHUB HUB: NUEVA GUI ====================
	-- Reconstruye tanto la carcasa como los controles con el diseño solicitado
	-- y enlaza cada fila con los estados y callbacks reales de KayzzHub Hub.
	;(function()
	_G.__CrystalModernGuiActive = true
	...
	Panel.Name = "KayzzHubModernPanel"
	local MODERN = {
	...
	local C = {
	bg = Color3.fromRGB(10, 32, 57),
	bgDark = Color3.fromRGB(8, 30, 55),
	row = Color3.fromRGB(16, 38, 63),
	accent = Color3.fromRGB(178, 205, 220),
	accentDim = Color3.fromRGB(65, 88, 110),
	text = Color3.fromRGB(215, 242, 255),
	textDim = Color3.fromRGB(138, 163, 180),
	textMuted = Color3.fromRGB(89, 113, 133),
	divider = Color3.fromRGB(34, 57, 80),
	}
	...
	pcall(saveConfig)
	elseif target.Name == "KayzzHubRestoreButton" then
	...
	inner.Parent = Panel
	corner(inner, 24)
	local innerStroke = stroke(inner, Color3.fromRGB(45, 67, 90), 1.5)

	local background = Instance.new("ImageLabel")
	background.Name = "BackgroundImage"
	background.Size = UDim2.new(1, 0, 1, 0)
	background.BackgroundTransparency = 1
	-- Embedded KayzzHub background image (self-contained; no external upload required)
	local function __KayzzHubDecodeBase64(data)
		local chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
		data = data:gsub("[^" .. chars .. "=]", "")
		return (data:gsub(".", function(x)
			if x == "=" then return "" end
			local p = chars:find(x, 1, true) - 1
			local bits = ""
			for i = 6, 1, -1 do
				bits = bits .. (((p % 2^i) - (p % 2^(i - 1)) > 0) and "1" or "0")
			end
			return bits
			...
			local n = 0
			for i = 1, 8 do
				if bits:sub(i, i) == "1" then n = n + 2^(8 - i) end
			end
			return string.char(n)
		end))
	end

	local function __KayzzHubEmbeddedBackground()
		local path = "KayzzHub_Sasuke_Background.jpg"
		local loader = nil
		pcall(function()
			loader = (typeof(getcustomasset) == "function" and getcustomasset)
				or (typeof(getsynasset) == "function" and getsynasset)
		end)
		if not loader or typeof(writefile) ~= "function" then return nil end
		local imageData = __KayzzHubDecodeBase64([[

		]])
		local okWrite = pcall(writefile, path, imageData)
		if not okWrite then return nil end
		local okAsset, asset = pcall(loader, path)
		if okAsset and type(asset) == "string" and asset ~= "" then return asset end
		return nil
	end

	local GUI_THEME_IMAGES = { ["GUI 1"] = __KayzzHubEmbeddedBackground() or "rbxassetid://114056083769059" }
	...
	pcall(_G.__CrystalRefreshESPTheme, _G.__CrystalThemeAccent, Color3.fromRGB(8, 30, 55))
	end
	...
	corner(statsPanel, 8)
	stroke(statsPanel, Color3.fromRGB(45, 67, 90), 1)
	...
	stroke(closeButton, Color3.fromRGB(45, 67, 90), 1)
	...
	object:SetAttribute("KayzzHubKeepBlackText", true)
	...
	bind.ZIndex = 8
	bind.Parent = parent
	corner(bind, 5); stroke(bind, Color3.fromRGB(53, 76, 98), 1)
	...
	boxFrame.Parent = row
	corner(boxFrame, 6); stroke(boxFrame, Color3.fromRGB(53, 76, 98), 1)
	...
	box.ClearTextOnFocus = false
	box.Parent = row
	corner(box, 5); stroke(box, Color3.fromRGB(53, 76, 98), 1)
	box.FocusLost:Connect(function()
	local number = tonumber(box.Text)
	...
	deleteButton.BackgroundColor3 = Color3.fromRGB(55, 145, 220)
	deleteButton.BorderSizePixel = 0
	deleteButton.Text = "X"
	deleteButton.TextColor3 = Color3.fromRGB(110, 190, 250)
	...
	errorLabel.Text = ""
	errorLabel.TextColor3 = Color3.fromRGB(110, 190, 250)
	...
	activeMarker.BackgroundColor3 = Color3.fromRGB(8, 30, 55)
	...
	active = value == true
	local targetColor = active and Color3.fromRGB(72, 95, 116) or C.row
	...
	button.ZIndex = 8
	button.Parent = row
	corner(button, 5); stroke(button, Color3.fromRGB(45, 67, 90), 1)
	...
	corner(tpBatConfigToggle, 6); stroke(tpBatConfigToggle, Color3.fromRGB(75, 170, 240), 1)
	...
	tpBatConfigTrack.BackgroundColor3 = Color3.fromRGB(33, 56, 79)
	...
	tpBatConfigKnob.BackgroundColor3 = Color3.fromRGB(110, 190, 250)
	...
	corner(tpBatInlineBind, 5); stroke(tpBatInlineBind, Color3.fromRGB(53, 76, 98), 1)
	...
	corner(tpBatDistanceBox, 5); stroke(tpBatDistanceBox, Color3.fromRGB(75, 170, 240), 1)
	...
	corner(tpBatVersionBox, 5); stroke(tpBatVersionBox, Color3.fromRGB(75, 170, 240), 1)
	...
	tpBatConfigTrack.BackgroundColor3 = tpBatConfigOpen and C.accent or Color3.fromRGB(33, 56, 79)
	tpBatConfigKnob.BackgroundColor3 = tpBatConfigOpen and Color3.fromRGB(209, 236, 249) or Color3.fromRGB(110, 190, 250)
	...
	-- Open Lagger / Open Bypass intentionally removed from the Visual panel.
	-- Their dedicated controls remain elsewhere in the script, but these two
	-- rows are no longer created here and therefore cannot be activated from
	-- the left-hand panel.
	...
	button.BackgroundColor3 = Color3.fromRGB(26, 48, 72)
	...
	miniButton.Name = "KayzzHubRestoreButton"
	...
	miniButton.Text = "<b><i>KayzzHub</i></b>"
	miniButton.TextColor3 = Color3.fromRGB(170, 220, 255)
	...
	corner(miniButton, 8)
	stroke(miniButton, Color3.fromRGB(45, 67, 90), 1.2)
	...
	blackout.BackgroundColor3 = Color3.fromRGB(8, 30, 55)
	...
	listeningBindBtn.BackgroundColor3 = Color3.fromRGB(170, 220, 255)
	listeningBindBtn.TextColor3 = Color3.fromRGB(75, 170, 240)
